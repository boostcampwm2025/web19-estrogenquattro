...
export class Auto1769701041258 implements MigrationInterface {
  name = 'Auto1769701041258';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "players" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "social_id" bigint NOT NULL, "nickname" varchar(20) NOT NULL, "equipped_pet_id" integer, "total_point" integer NOT NULL DEFAULT (100), "is_newbie" boolean NOT NULL DEFAULT (1), CONSTRAINT "UQ_e304f5048f92add68e1f8c0ce03" UNIQUE ("social_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tasks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar(100) NOT NULL, "total_focus_seconds" integer NOT NULL DEFAULT (0), "completed_at" datetime, "created_at" datetime NOT NULL, "player_id" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "point_history" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar CHECK( "type" IN ('ISSUE_OPEN','PR_OPEN','PR_MERGED','PR_REVIEWED','COMMITTED','TASK_COMPLETED','FOCUSED') ) NOT NULL, "amount" integer NOT NULL, "repository" varchar(100), "description" varchar(200), "created_at" datetime NOT NULL DEFAULT (datetime('now')), "activity_at" datetime, "player_id" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "daily_point" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" integer NOT NULL, "created_at" datetime NOT NULL, "player_id" integer)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "daily_github_activity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar CHECK( "type" IN ('ISSUE_OPEN','PR_OPEN','PR_MERGED','PR_REVIEWED','COMMITTED') ) NOT NULL, "count" integer NOT NULL DEFAULT (0), "created_at" datetime NOT NULL, "player_id" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "daily_focus_time" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "total_focus_seconds" integer NOT NULL DEFAULT (0), "status" varchar CHECK( "status" IN ('FOCUSING','RESTING') ) NOT NULL DEFAULT ('RESTING'), "created_at" datetime NOT NULL, "last_focus_start_time" datetime, "current_task_id" integer, "player_id" integer)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_players"("id", "social_id", "nickname", "equipped_pet_id", "total_point", "is_newbie") SELECT "id", "social_id", "nickname", "equipped_pet_id", "total_point", "is_newbie" FROM "players"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_tasks"("id", "description", "total_focus_seconds", "completed_at", "created_at", "player_id") SELECT "id", "description", "total_focus_seconds", "completed_at", "created_at", "player_id" FROM "tasks"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_point_history"("id", "type", "amount", "repository", "description", "created_at", "activity_at", "player_id") SELECT "id", "type", "amount", "repository", "description", "created_at", "activity_at", "player_id" FROM "point_history"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_daily_point" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" integer NOT NULL, "created_at" datetime NOT NULL, "player_id" integer, CONSTRAINT "FK_19912a03fba8a7f76db50d243fa" FOREIGN KEY ("player_id") REFERENCES "players" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_daily_point"("id", "amount", "created_at", "player_id") SELECT "id", "amount", "created_at", "player_id" FROM "daily_point"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_daily_github_activity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar CHECK( "type" IN ('ISSUE_OPEN','PR_OPEN','PR_MERGED','PR_REVIEWED','COMMITTED') ) NOT NULL, "count" integer NOT NULL DEFAULT (0), "created_at" datetime NOT NULL, "player_id" integer, CONSTRAINT "FK_f3db5effec9c9e17df48951c69f" FOREIGN KEY ("player_id") REFERENCES "players" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_daily_github_activity"("id", "type", "count", "created_at", "player_id") SELECT "id", "type", "count", "created_at", "player_id" FROM "daily_github_activity"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "daily_github_activity"("id", "type", "count", "created_at", "player_id") SELECT "id", "type", "count", "created_at", "player_id" FROM "temporary_daily_github_activity"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "daily_point"("id", "amount", "created_at", "player_id") SELECT "id", "amount", "created_at", "player_id" FROM "temporary_daily_point"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "point_history"("id", "type", "amount", "repository", "description", "created_at", "activity_at", "player_id") SELECT "id", "type", "amount", "repository", "description", "created_at", "activity_at", "player_id" FROM "temporary_point_history"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "tasks"("id", "description", "total_focus_seconds", "completed_at", "created_at", "player_id") SELECT "id", "description", "total_focus_seconds", "completed_at", "created_at", "player_id" FROM "temporary_tasks"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "players"("id", "social_id", "nickname", "equipped_pet_id", "total_point", "is_newbie") SELECT "id", "social_id", "nickname", "equipped_pet_id", "total_point", "is_newbie" FROM "temporary_players"`,
    );
