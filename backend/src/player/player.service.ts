...
const ITEM_CATALOG: Record<string, CatalogItem> = {
  sparkle: { cost: 100, type: 'effect' },
  electric: { cost: 100, type: 'effect' },
  fire: { cost: 100, type: 'effect' },
  matrix: { cost: 100, type: 'effect' },
  js: { cost: 50, type: 'lang' },
  ts: { cost: 50, type: 'lang' },
  rust: { cost: 50, type: 'lang' },
  java: { cost: 50, type: 'lang' },
  python: { cost: 50, type: 'lang' },
  kotlin: { cost: 50, type: 'lang' },
  C: { cost: 50, type: 'lang' },
  Cp: { cost: 50, type: 'lang' },
  go: { cost: 50, type: 'lang' },
  haskell: { cost: 50, type: 'lang' },
  nest: { cost: 50, type: 'lang' },
  pytorch: { cost: 50, type: 'lang' },
  react: { cost: 50, type: 'lang' },
  spring: { cost: 50, type: 'lang' },
  tensor: { cost: 50, type: 'lang' },
  swift: { cost: 50, type: 'lang' },
  hf: { cost: 50, type: 'lang' },
};
