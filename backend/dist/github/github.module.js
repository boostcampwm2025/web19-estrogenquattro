...
const github_poll_service_1 = require("./github.poll-service");
let GithubModule = class GithubModule {
};
exports.GithubModule = GithubModule;
exports.GithubModule = GithubModule = __decorate([
    (0, common_1.Module)({
        providers: [github_gateway_1.GithubGateway, github_poll_service_1.GithubPollService],
        exports: [github_gateway_1.GithubGateway, github_poll_service_1.GithubPollService],
    })
], GithubModule);
